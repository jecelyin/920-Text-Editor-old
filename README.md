## 920 Text Editor
**It is a run on the Android phone a powerful text editor, anywhere, you can easily view or edit your code,**
...
##920文本编辑器(920 Text Editor)
**它是一款运行于Android手机上功能强大的文本编辑器，使用它你可以在任何地方都可以方便地查看或编辑你的代码，**
