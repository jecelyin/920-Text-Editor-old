...
//                     int cursorOffset) { //jec-
                     int cursorOffset, Highlight mHighlight, Paint mLineNumberPaint, Paint mWhiteSpacePaint) { //jec+
        if (mDirect != null && highlight == null) {
            c.drawText(mDirect, 0, mBottom - mDesc, mPaint);
        } else {
//            super.draw(c, highlight, highlightpaint, cursorOffset); //jec-
            super.draw(c, highlight, highlightpaint, cursorOffset, null, null, null);
        }
    }
